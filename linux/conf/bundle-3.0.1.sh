...
DEPENDENCIES_COMMON="qtbase5-dev qtdeclarative5-dev qtmultimedia5-dev libqt5svg5 libtinyxml-dev libace-dev subversion cmake dpkg wget libeigen3-dev qml-module-qtquick2 qml-module-qtquick-window2 qml-module-qtmultimedia qml-module-qtquick-dialogs qml-module-qtquick-controls"
...
export YARP_PACKAGE_VERSION=3.0.1
...
YARP_CMAKE_OPTIONS="\
 ...
 -DENABLE_yarpmod_tranformClient=TRUE \
 -DENABLE_yarpmod_tranformServer=TRUE \
